...
class Dashboard extends Component {
  ...
  accounts(pageNumber) {
    ...
    _callApi(data, "/app/cancel/" + data.page, headerdata, 2).then((response) => {
  ...
  markCarReject(item) {
    ...
    _callApi(data, "/app/cancelreq", headerdata, 1).then((response) => {
      if (response.status === 200) {
        if (response.data.status === 200) {
          console.log(response.data.data);
          this.setState({
  ...
  handleChangeMarkRject = (event, item) => {
    ...
    return (
      <>
        ...
        <div class="dc-wrap main-dashboard dashboard-car-status">
          <div class="dc-header">
            <div class="dch-left">
              <h3 class="dc-head">Cancel Requests By App</h3>
            </div>
            <div class="dch-right">
              {/* <button
                type="button"
          ...
          <div class="dc-body">
            ...
            <NavLink to="/users/cancel-req-dashboard" onClick={this.viewMoreFunc}>
